...
const SaleSchema = new Schema(
  {
    ...
    items: [],
    subtotal: { type: mongoose.Schema.Types.Number, required: true },
    tax: { type: mongoose.Schema.Types.Number, required: true },
    discount: { type: mongoose.Schema.Types.Number, required: true },
